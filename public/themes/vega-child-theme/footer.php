    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="copyright"><?php echo wp_kses_post("&copy;".' '.$vega_wp_footer_copyright_message); ?><br /><span class="credit"><?php echo "<a href='".$link_address."'>Site by KMA</a>"; ?></span></div>
                <!-- /Copyright and Credits -->
            </div>
        </div>
    </div>
